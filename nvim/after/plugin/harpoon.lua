...
vim.keymap.set("n", "<C-h>", function() harpoon:list():select(1) end, {desc="1st file Harpoon"})
vim.keymap.set("n", "<C-t>", function() harpoon:list():select(2) end, {desc="2nd file Harpoon"})
vim.keymap.set("n", "<C-n>", function() harpoon:list():select(3) end, {desc="3rd file Harpoon"})
vim.keymap.set("n", "<C-s>", function() harpoon:list():select(4) end, {desc="4th file Harpoon"})
